...
const Chart = () =>{
  ...
  const getData =  () => {
    ...
    let _sem_2_5 = [];
     ...
     .then(res => {
        ...
        if(_sem_1_1 < 10 ){
          setCadeira1_1("Álgebra" + ', ');
        }
        if(_sem_1_2 < 10 ){
          setCadeira1_2("Análise I" + ', ');
        }
        if(_sem_1_3 < 10 ){
          setCadeira1_3("Lab I"+ ', ');
        }
        ...
        if(_sem_1_5 < 10 ){
          setCadeira1_5("Tópicos"+ ', ');
        }
        if(_sem_2_1 < 10 ){
          setCadeira2_1("Análise II"+ ', ');
        }
        if(_sem_2_2 < 10 ){
          setCadeira2_2("SD"+ ', ');
        }
  ...
  return (
    <table width="400" height="0">
      ...
      <tr>
      <td>
      <div><b>Médias dos alunos do 1º ano do Curso</b>
