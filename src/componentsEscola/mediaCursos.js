...
const Chart = () =>{
  ...
  const getData =  () => {
    ...
    let _curso5 = [];
     ...
     .then(res => {
        var curso1 = (res.data.cursos[0].mediafinal_1ano + res.data.cursos[0].mediafinal_2ano + res.data.cursos[0].mediafinal_3ano) /3;
        _curso.push(parseInt(curso1));
        var curso2 = (res.data.cursos[1].mediafinal_1ano + res.data.cursos[1].mediafinal_2ano + res.data.cursos[1].mediafinal_3ano) /3;
        _curso.push(parseInt(curso2));
        var curso3 = (res.data.cursos[2].mediafinal_1ano + res.data.cursos[2].mediafinal_2ano + res.data.cursos[2].mediafinal_3ano) /3;
        _curso.push(parseInt(curso3));
        var curso4 = (res.data.cursos[3].mediafinal_1ano + res.data.cursos[3].mediafinal_2ano + res.data.cursos[3].mediafinal_3ano) /3;
        _curso.push(parseInt(curso4));
        var curso5 = (res.data.cursos[4].mediafinal_1ano + res.data.cursos[4].mediafinal_2ano + res.data.cursos[4].mediafinal_3ano) /3;
