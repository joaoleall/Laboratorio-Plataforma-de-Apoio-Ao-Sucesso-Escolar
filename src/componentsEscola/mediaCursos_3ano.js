...
const Chart = () =>{
  ...
  const getData =  () => {
    ...
    let _curso5 = [];
     ...
     .then(res => {
        var curso1 = res.data.cursos[0].mediafinal_3ano;
        _curso.push(parseInt(curso1));
        var curso2 = res.data.cursos[1].mediafinal_3ano;
        _curso.push(parseInt(curso2));
        var curso3 = res.data.cursos[2].mediafinal_3ano;
        _curso.push(parseInt(curso3));
        var curso4 =  res.data.cursos[3].mediafinal_3ano;
        _curso.push(parseInt(curso4));
        var curso5 = res.data.cursos[4].mediafinal_3ano;
  ...
  return (
    <table width="200" height="200">
      ...
      <tr>
      <td>
      <div><b>Médias dos Cursos no 3º ano</b>
      <Bar
           data={chart}
           options={{ 
             responsive: true,
